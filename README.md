...
| [@ffflorian/oxlint-config](./packages/oxlint-config) | oxlint config for JS and TS projects | [![npm version](https://img.shields.io/npm/v/@ffflorian/oxlint-config.svg)](https://npmjs.com/package/@ffflorian/oxlint-config) |
